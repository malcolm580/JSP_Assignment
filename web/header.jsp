...
<div class="w3-top">
    <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
        ...
        <div class="w3-dropdown-hover w3-hide-small w3-right">
            ...
            <div class="w3-dropdown-content w3-card-4 w3-bar-block w3-right-align " style="width:300px">
                <a href="./main?action=logout" class="w3-bar-item w3-button w3-right-align">Logout</a>
                <a href="#" class="w3-bar-item w3-button w3-right-align">John Doe posted on your wall</a>
                <a href="#" class="w3-bar-item w3-button w3-right-align">Jane likes your post</a>
            </div>
        </div>
    </div>
</div>
